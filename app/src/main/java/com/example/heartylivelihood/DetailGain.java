...
public class DetailGain {
    public String title,calorie,right_time,worst_time,best_consume,fat,sodium,carbo,fiber,sugar,protien,benifits;

    public DetailGain(){

    }
    public DetailGain(String title,String calorie,String right_time,String worst_time,String best_consume,String fat,String sodium,String carbo, String fiber,String sugar, String protien, String benifits)
    {
        this.title=title;
